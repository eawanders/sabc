...
export default function EventsPageClient() {
  ...
  if (loading) {
    return (
      <main className="flex flex-col mobile-events-page">
        <h1 className="font-bold mobile-hide-header" style={{ fontSize: '32px', marginBottom: 40 }}>Events</h1>
  ...
  if (events.length === 0) {
    return (
        <main className="flex flex-col mobile-events-page">
          <h1 className="font-bold mobile-hide-header" style={{ fontSize: '32px', marginBottom: 100 }}>Events</h1>
          <div className="text-center py-12 flex items-center justify-center" style={{ width: '100%', minHeight: '200px' }}>
  ...
  return (
    <main className="flex flex-col bg-transparent mobile-events-page">
      <h1 className="font-bold flex-shrink-0 mobile-hide-header" style={{ fontSize: '32px', marginBottom: 100 }}>Events</h1>
